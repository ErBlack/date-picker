...
class DatePicker extends HTMLElement {
    ...
    constructor() {
        ...
        this._onMouseDoun = this._onMouseDoun.bind(this);
    ...
    set value(value) {
        ...
        const needRedraw = (this._selectedDate === null && !isNaN(parsed)) || this._selectedDate.isSame(parsed, 'day');
    ...
    _init() {
        ...
        const parsed = Date.parse(this.getAttribute('value'));
        ...
        this._calendar.addEventListener('mousedown', this._onMouseDoun);
